...
export default function Page() {
  return (
    <div className="pt-32 pb-24 px-8 max-w-5xl mx-auto">
      <span className="font-mono text-tertiary text-xs tracking-[0.3em] uppercase">/about</span>
      ...
      <p className="font-body text-xl text-on-surface-variant mt-6 italic max-w-2xl">
        The full record — bio, education, résumé, and how to reach me. Coming in the next build phase.
      </p>
    </div>
  );
}
