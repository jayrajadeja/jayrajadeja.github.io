  ...
  return (
    ...
    >
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,300,0,0&icon_names=code,description,edit_note,mail,north_east,work&display=swap"
          rel="stylesheet"
        />
      </head>
